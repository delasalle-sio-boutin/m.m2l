...
if ($laReservation) {
	...
	$laReservation = $dao->getReservation("");
	if ($laReservation)
...
$ok = $dao->supprimerUtilisateur("bourgeoiss");
if ($ok)
...
$reponse = $dao->testerDigicodeBatiment("C18D1E");
echo "<p>L'appel de testerDigicodeBatiment('C18D1E') donne : <b>" . $reponse . "</b><br>";
...
$reponse = $dao->testerDigicodeSalle("13", "C18D1E");
echo "<p>L'appel de testerDigicodeSalle('13', 'C18D1E') donne : <b>" . $reponse . "</b><br>";
