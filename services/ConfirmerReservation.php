...
// Modifié le 22/11/2016 par Bienvenu Erwann

// Ce service web permet à un utilisateur de confirmer ses réservations
// et fournit un flux XML contenant un compte-rendu d'exécution

// Le service web doit recevoir 3 paramètres : nom, mdp, le numéro de réservation
// Les paramètres peuvent être passés par la méthode GET (pratique pour les tests, mais à éviter en exploitation) :
//     http://<hébergeur>/ConsulterReservations.php?nom=zenelsy&mdp=passe&res=numReservation
